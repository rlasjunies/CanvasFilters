...
function grayscale() {
    var c: mtg.util.canvas.Canvas = new mtg.util.canvas.Canvas( <HTMLImageElement> document.getElementById( 'orig' ) );
    var imgDest: HTMLImageElement = <HTMLImageElement>document.getElementById( 'dest' );
    c.grayscale();    
...
function sobel() {
    var gray: mtg.util.canvas.Canvas = new mtg.util.canvas.Canvas( <HTMLImageElement> document.getElementById( 'orig' ) );
    var imgDest: HTMLImageElement = <HTMLImageElement>document.getElementById( 'dest' );
    gray.grayscale();
